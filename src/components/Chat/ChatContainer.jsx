...
export default function ChatContainer({ messages, completion, isLoading, documents }) {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        {messages.length === 0 && !completion && !isLoading && <WelcomeMessage />}
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Mostra a completion em andamento */}
          {completion && (
            <MessageBubble
              message={completion}
              isUser={false}
          ...
          {isLoading && !completion && <TypingIndicator />}
