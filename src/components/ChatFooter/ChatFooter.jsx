...
export default function ChatFooter({ input, handleInputChange, handleSubmit, isLoading }) {
    ...
    <footer className="flex flex-col items-start gap-3 border-t border-[#1E2939] bg-[#0E1117] px-6 pt-4 pb-3 h-[100px]">
      ...
      >
        <input
          ...
          disabled={isLoading}
          className="flex w-7xl h-9 items-center rounded-[14px] border border-[#364153] bg-[#101828] px-3 py-1 text-white placeholder-[#6A7282] focus:outline-none focus:ring-2 focus:ring-[#4B5563] selection:bg-[#364153] selection:text-white disabled:opacity-50 disabled:cursor-not-allowed"
        />
